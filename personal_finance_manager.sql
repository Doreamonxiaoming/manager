...
insert  into `tb_follow`(`id`,`name`,`categoryID`,`transactTime`,`amount`,`detail`) values (0,'transaction0',0,'2020/09/11',100,'ok');
insert  into `tb_follow`(`id`,`name`,`categoryID`,`transactTime`,`amount`,`detail`) values (1,'transaction1',1,'2020/09/11',100,'ok');
